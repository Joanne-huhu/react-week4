                ...
                <tbody>
                  {products.map((product) => (
                    <tr key={product.id}>
                      ...
                      <button onClick={()=>handleOpenDeleteProductModal(product)} type="button" className="btn btn-outline-danger btn-sm">刪除</button>
                      </div>
                      </td>
                    </tr>
                  ))}
